 ...
 * Write a notice.
 *
 * The stock form was three stacked rows in a bare card and a TinyMCE
 * with Helvetica content and no direction, so Persian came out ragged
 * and left-aligned. This adds: an RTL editor with the panel's own
 * Persian face, a row of ready-made snippets, and a live preview that
 * shows the notice exactly as the user's popup will render it.
 *
 * The save contract is untouched — #title #status #sendmail #content
 * and saveNotice() POST the same fields to /admin/notice/save.
 * ================================================================== */
...
/* preview mirrors the user popup card */
.nadm-prev {
	position: sticky;
	top: 20px;
}
	...
	<div class="page-header">
		<div class="row align-items-end">
			<div class="col-sm mb-2 mb-sm-0">
				<h1 class="page-header-title">📢 {$translate->get('AddNotice')}</h1>
			</div>
		</div>
	</div>
		...
		<div class="nadm-card">
			...
			<div class="nadm-card-body">
				...
				<div class="nadm-field">
					...
					<input type="text" class="form-control shadow-lg" id="title" name="title" placeholder="{$translate->get('Title')}">
				</div>
				...
				<div class="nadm-field">
					...
					<textarea id="content" class="display shadow-lg"></textarea>
				</div>
			</div>
		</div>
